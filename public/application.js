...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://rocky-cove-71260.herokuapp.com/'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showEvents = __webpack_require__(12);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onStartState = function onStartState(event) {
	  event.preventDefault();
	  ui.startState;
	};
	...
	var onCreateShow = function onCreateShow(event) {
	  event.preventDefault();
	  console.log('you have reached onCreateShow');
	  var data = getFormFields(event.target);
	  console.log('this is data from onCreateShow', data);
	  api.createShow(data).then(ui.createShowSuccess).catch(ui.createShowFailure);
	};

	// Show all of a user's shows

	var onShowAllShows = function onShowAllShows(event) {
	  event.preventDefault();
	  console.log('You have arrived at onShowAllShows');
	  var data = getFormFields(event.target);
	  console.log(data);
	  api.showAllShows().then(ui.showShowsSuccess).catch(ui.showShowsFailure);
	};

	// Update a show

	var onUpdateShow = function onUpdateShow(event) {
	  event.preventDefault();
	  var data = {};
	  data.shows = getFormFields(event.target);
	  var showNumber = data.shows.show.id;
	  var showObject = data.shows;
	  console.log('This is data.shows: ', data.shows);
	  api.updateShow(showObject, showNumber).then(ui.updateShowSuccess).catch(ui.updateShowFailure);
	};
	...
	var onDeleteShow = function onDeleteShow(event) {
	  ...
	  // debugger;
	  api.deleteShow(id.show.id).then(ui.deleteShowSuccess).catch(ui.deleteShowFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createShow = function createShow(data) {
	  return $.ajax({
	...
	var showAllShows = function showAllShows() {
	  return $.ajax({
	    url: config.apiOrigin + '/shows/',
	    method: 'GET',
	    headers: {
	...
	var updateShow = function updateShow(showObject, showNumber) {
	  // debugger
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ShowsTemplate = __webpack_require__(15);
	var store = __webpack_require__(5);
	...
	var createShowSuccess = function createShowSuccess(response) {
	...
	var createShowFailure = function createShowFailure(response) {
	...
	var validateShowShow = function validateShowShow(response) {
	...
	var showShowsSuccess = function showShowsSuccess(response) {
	  ...
	  if (store.shows == '') {
	    ...
	    $('#show-list').show();
	    var ShowList = ShowsTemplate({ shows: store.shows });
	...
	var showChoreFailure = function showChoreFailure(response) {
	...
	var noChoresYet = function noChoresYet(response) {
	  $('#usermessages').text('You don\'t have any chores yet. How about adding some using Create A Chore below?');
	};

	// Chore Update

	var updateShowSuccess = function updateShowSuccess(response) {
	...
	var updateShowFailure = function updateShowFailure(response) {
	  $('#usermessages').text('Updating a chore failed. Try again?');
	};

	// Chore Delete

	var deleteShowSuccess = function deleteShowSuccess(response) {
	...
	var deleteShowFailure = function deleteShowFailure(response) {
	...
	module.exports = {
	  ...
	  createShowFailure: createShowFailure,
	  validateShowShow: validateShowShow,
	  showShowsSuccess: showShowsSuccess,
	  showChoreFailure: showChoreFailure,
	  noChoresYet: noChoresYet,
	  updateShowSuccess: updateShowSuccess,
	  updateShowFailure: updateShowFailure,
	  deleteShowSuccess: deleteShowSuccess,
	  deleteShowFailure: deleteShowFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class=\"container\">\n  <!-- change back to row below -->\n<div class=\"row\">\n  <div class=\"col-lg-4 col-md-4 col-sm-12 col-xs-12\">\n    <div class=\"thumbnail\">\n      <div class=\"caption\">\n<div id='show-listing' data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n\n  <h3>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.show_name : stack1), depth0))
	    + "</h3>\n  <p>Show ID: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</p>\n  <p>Date: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.show_date : stack1), depth0))
	    + "</p>\n  <p>Time: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.show_time : stack1), depth0))
	    + "</p>\n  <p>Notes:<br> "
	  ...
	  return "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.shows : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
